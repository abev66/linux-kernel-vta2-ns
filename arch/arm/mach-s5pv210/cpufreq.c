...
static u32 clkdiv_val[6][11] = {
	...
	/* L0 : [1248/200/100][166/83][133/66][200/200] */
			  ...
			  unsigned int relation)
{
	...
	if (pll_changing) {
		 ...
		 */
		if (index == L0)
			__raw_writel(APLL_VAL_1248, S5P_APLL_CON);
        else if (index == L1)
	...
	/*
	 * L5 and L0 level need to change memory bus speed, hence onedram clock divier
